...
= 3.1.3 =
* Fix - Removed an orphaned AJAX hook that referenced a nonexistent callback.
...
* Fix - Input limitation addon maximum limitation
...
* Fix - Input limitation for wc blocks

= 1.3.8.1 =
* Enhancement - Compatibility version: Wordpress 6.8 and WooCommerce 10.0
